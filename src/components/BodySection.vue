      ...
      >
        ...
        >
          <f-text variant="para" size="medium" weight="regular" state="default">
            A design system that consists of principles, patterns, guidelines,
            and processes to enable design at scale.
          </f-text>
        </f-div>
      </f-div>
    </f-div>
        ...
        <f-div padding="none" align="top-left" direction="column" gap="small">
          ...
          <f-div padding="none" align="top-left" direction="column" gap="small">
            ...
            <f-div padding="none" align="top-left">
              <a :href="item?.link1?.link" target="_blank">
                <f-text
                  variant="para"
                  size="small"
                  weight="regular"
            ...
            <f-div padding="none" align="top-left">
              <a :href="item?.link2?.link" target="_blank">
                <f-text
                  variant="para"
                  size="small"
                  weight="regular"
            ...
            <f-div padding="none" align="top-left" v-if="item?.link3">
              <a :href="item?.link1?.link" target="_blank">
                <f-text
                  variant="para"
                  size="small"
